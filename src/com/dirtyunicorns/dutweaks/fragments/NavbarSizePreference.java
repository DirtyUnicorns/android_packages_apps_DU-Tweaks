...
public class NavbarSizePreference extends DialogPreference implements
    ...
    public NavbarSizePreference(Context context, AttributeSet attrs) {
        ...
        // load user settings
        mHValue = Settings.System.getInt(cr, Settings.System.NAVIGATION_BAR_HEIGHT, mDefaultHeight);
        mWValue = Settings.System.getInt(cr, Settings.System.NAVIGATION_BAR_WIDTH, mDefaultWidth);
        mLValue = Settings.System.getInt(cr, Settings.System.NAVIGATION_BAR_HEIGHT_LANDSCAPE, mDefaultHeightLandscape);
        ...
        if (fromUser) {
            if (seekbar == mNavigationBarHeight) {
                ...
                Settings.System.putInt(cr,
                        Settings.System.NAVIGATION_BAR_HEIGHT, mHValue);
                ...
                Settings.System.putInt(cr,
                        Settings.System.NAVIGATION_BAR_WIDTH, mWValue);
                ...
                Settings.System.putInt(cr,
                        Settings.System.NAVIGATION_BAR_HEIGHT_LANDSCAPE, mLValue);
            }
        }
    }
